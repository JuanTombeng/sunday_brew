...
export const getServerSideProps = async () => {
    const response = await fetch(`${process.env.NEXT_APP_BACKEND_URL}/v1/articles/?category=politics`, {
        method : 'GET'
    })
...
ArticlePolitics.getLayout = function getLayout(children) {
    return (
      <MainLayout>
        {children}
      </MainLayout>
...
export default ArticlePolitics